      ...
      <div class="auto bp-center bp-rel anim-content" data-stellar-ratio="0.5">
		...
		<div id="contactMe" class="layer layer5 bp-rel" data-stellar-background-ratio="0.4">
			<div class="auto bp-center anim-content bp-rel">
				...
				<h2><?php echo $title; ?></h2>
				<h3><?php echo $subtitle; ?></h3>
				<div id="frmContact" class="contact-form">
					<div id="mail-status"></div>
					<ul class="anim-content">
						<li>
							<span id="userName-info" class="info"></span>
							<input type="text" name="userName" id="userName" class="demoInputBox" placeholder="Enter your name">
						</li>
						<li>
							<span id="userEmail-info" class="info"></span>
							<input type="text" name="userEmail" id="userEmail" class="demoInputBox" placeholder="Enter your email">
						</li>
						<li>
							<span id="content-info" class="info"></span>
							<textarea name="content" id="content" class="demoInputBox" cols="60" rows="6" placeholder="Message"></textarea>
						</li>
						<li>
